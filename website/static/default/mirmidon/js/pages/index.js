...
$(document).ready(function(){
	...
	$('.confirmpaymentajax').on('click', function() { // This event fires when a button is clicked
      var idreg = $(this).attr('id');
			var currurl = $('.currenturl').attr('id');
			/*$.ajax({
							url: 'http://localhost/anlene-waktunyabergerak/mirmidon/registration/confirmpayment',
							type: "POST",
							data: { id : idreg },
							dataType: "json"
							})
